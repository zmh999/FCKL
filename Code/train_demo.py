...
def main():
    ...
    parser.add_argument('--val_iter', default=700, type=int,
    ...
    parser.add_argument('--only_test', action='store_true',
           help='only test')
    parser.add_argument('--ckpt_name', type=str, default='55H',  ###55C0d2
    ...
    if opt.pair:
        ...
        train_data_loader = get_loader(opt.train, sentence_encoder,
                N=trainN, K=K, Q=Q*1, na_rate=opt.na_rate, batch_size=batch_size, single=Signle) #######
        val_data_loader = get_loader(opt.val, sentence_encoder,
                N=N, K=1, Q=Q, na_rate=opt.na_rate, batch_size=batch_size,single=Signle)#######
        ...
        if opt.adv:
            adv_data_loader = get_loader_unsupervised(opt.adv, sentence_encoder,
                N=trainN, K=1, Q=Q, na_rate=opt.na_rate, batch_size=batch_size) ####################
