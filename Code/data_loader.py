...
class FewRelDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        support_set = {'word': [], 'pos1': [], 'pos2': [], 'pos3': [], 'pos4': [], 'pos5': [], 'pos6': [], 'pos7': [], 'pos8': [], 'mask': [] }
        query_set = {'word': [], 'pos1': [], 'pos2': [], 'pos3': [], 'pos4': [], 'pos5': [], 'pos6': [], 'pos7': [], 'pos8': [], 'mask': [] }
        query_label = []
...
def collate_fn(data):
    batch_support = {'word': [], 'pos1': [], 'pos2': [], 'pos3': [], 'pos4': [], 'pos5': [], 'pos6': [], 'pos7': [], 'pos8': [], 'mask': [] }
    batch_query = {'word': [], 'pos1': [], 'pos2': [], 'pos3': [], 'pos4': [], 'pos5': [], 'pos6': [], 'pos7': [], 'pos8': [], 'mask': [] }
    batch_label = []
